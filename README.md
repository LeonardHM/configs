...
| :---: | :--- | :--- | :--- | :--- |
| ![100%](https://img.shields.io/badge/100%25-brightgreen) | `--conectar_wifi` | `y\|n` | Conecta à rede Wi-Fi configurada. | `--WIFI_CONFIGS --WIFI_IP_ADDRESS --WIFI_GATEWAY --WIFI_DNS` |
