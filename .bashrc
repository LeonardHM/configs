...
if [ "$(id -u)" = "0" ]; then # Prompt para root
    PS1="\[\e[0;31m\]┌─[\[\e[0;34m\]root\[\e[0;31m\]@\[\e[0;36m\]$(hostname)\[\e[0;31m\]]─[\[\e[0;32m\]\w\[\e[0;31m\]]\n\[\033[0;31m\]└──╼ \[\e[0;31m\]#\[\e[0m\] "

else # Prompt para usuários comuns
    PS1="\[\033[0;31m\]┌─[\[\033[1;34m\]$USER\[\033[1;33m\]@\[\033[1;36m\]$(hostname)\[\033[0;31m\]]─[\[\033[0;32m\]\w\[\033[0;31m\]]\n\[\033[0;31m\]└──╼ \[\033[1;31m\]❯\[\033[1;34m\]❯\[\033[1;90m\]❯\[\033[0m\] "
...
case "$TERM" in
    xterm*|rxvt*)
        if [ "$(id -u)" = "0" ]; then
            PS1="\[\e]0;root@$(hostname): \w\a\]$PS1"
        else
            PS1="\[\e]0;$USER@$(hostname): \w\a\]$PS1"
        fi
        ;;
    *) ;;
...
shopt -s checkwinsize # Verifica o tamanho da janela após cada comando
...
alias ll='ls -lh' # Lista arquivos detalhadamente
alias la='ls -la' # Lista todos os arquivos, exceto os ocultos padrão
